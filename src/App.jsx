...
const App = () => {
  ...
  const editionDrop = useEditionDrop("0x12951f264BA74D8f893ceB16f45131dAA755D79a");
  const token = useToken("0x691055C66fBE3c8EdF63B99804E0f79384A6F924");
  const vote = useVote("0xe8dDFB033AEE90f426c4a7a34741a67E74f7E066");
  ...
  if (hasClaimedNFT) {
    return (
      ...
      <p>Parabéns por fazer parte da minha DAO!</p>
      <div>
        <div>
    ...
    return (
      <div className="mint-nft">
        <h1>Cunhe gratuitamente seu NFT de membro da FreedomDAO</h1>
        <button
          disabled={isClaiming}
          onClick={mintNft}
        >
