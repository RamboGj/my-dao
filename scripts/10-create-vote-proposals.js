...
const vote = sdk.getVote("0xe8dDFB033AEE90f426c4a7a34741a67E74f7E066");
...
(async () => {
    ...
    try {
        ...
        const description = "A DAO deveria transferir " + amount + " tokens do tesouro para " + process.env.WALLET_ADDRESS + " por ser gente boa?";
        ...
        await vote.propose(description, executions);
        console.log("✅ Proposta de dar prêmio do tesouro para si mesmo criada com sucesso, vamos torcer para votarem sim!");
    } catch (error) {
